...
const historyData = {
    ...
    "Luxor": { name: "Luxor Temple", lon: 32.6391, lat: 25.6995, baseFact: "East bank Nile temple.", img: "", branches: [{label: "Pharaohs", text: "Built by Amenhotep III and Ramesses II."}] },
    "AbuSimbel": { name: "Abu Simbel", lon: 31.6255, lat: 22.3372, baseFact: "Rock-cut temples of Ramesses II.", img: "", branches: [{label: "Rescue", text: "Relocated in 1968 to save from floods."}] },
